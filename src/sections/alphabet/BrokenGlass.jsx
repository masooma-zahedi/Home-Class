...
//   },
  ...
  // {
  //   category: "ل",
  //   words: ["لاک","بالا","لیز","کالا","سالو","لولا","لوک","پِلاک","پولاد","کِلاس","لِباس","بُلور","لوکس","زُلال","جَلال","بالارو","دِلاوَر","لاک پُشت","سالاد",],
  // },
//   {
//     category: "م",
...
// {
//   category: "ه",
//  words: ["هیزُم","هَمکار","هَمراه","هَفته","هال","هَشتُم","هوش","هِزارپا","گُناه","گاه","شانِه","خانه","نامِه","راه","چاه","کوه","هَمِه","آگاه","زیبارو","کِلاه","شیشِه","آهو","سِپیده","ماه","دانِه","توبِه","شُجاعانه","قَهوه"] 
// },
  // {
  //   category:"حرف ظ",
  //   words:  ["ظَرف","نَظَر","ناظِر","حافِظ","نِظام","مَظروف","ظاهِر","مَظلوم","نِظافَت","مُنظَم"],
  // },
  {
    category:"حرف و",
    words:  ["وَطَن","وَقت","وَسَط","وَکیل","وُرد","وَعدِه","وَزن","دوست","وَجه","سَوار","نَوَرد","کوتاه","نِوِشتَن","پَروَندِه","شورا",],
  },
...
const BrokenGlass = () => {
  ...
  return (
    <>
      ...
      {/* نمایش کلمات */}
      <section className="mt-5 border border-info mx-2" style={{background:"linear-gradient(135deg, #ecc079ff, #dca4b4ff)"}}>
        <div style={{ }}>
          <div
            className="mx-2  row"
            style={{
